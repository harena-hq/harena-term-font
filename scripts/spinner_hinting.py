...
The live Claude Code spinner branches use `· ✢ ✳ ✶ ✻` on Ghostty and
`· ✢ * ✶ ✻ ✽` elsewhere. Their source outlines share essentially one
vertical centre, but `ttfautohint` can snap each shape to a different pixel
phase. Measure a probe
...
# Union of the live Ghostty and non-Ghostty frame sets. Claude Code 2.1.280
# uses U+2733 ✳ on Ghostty but ASCII U+002A * elsewhere.
SPINNER = "·✢✳✶✻✽*"
PPEMS = range(13, 19)
DELTA_STEP = 0.125
MAX_DELTA = 1.0
