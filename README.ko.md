...
출시 바이너리 실측: 한글 `T = 0.1308`, **Sarasa 대비 50% 더 촘촘**, 격자는 여전히
정확히 1:2.
...
한국과 일본은 같은 한자를 다르게 그립니다. 가장 뚜렷한 예가 辵 부수로, 한국은
전통적인 두 점 辶을 쓰고 일본 신자체는 한 점을 씁니다. 일상 한자에 그대로
나타납니다: 運 進 週 選 過 達 通 連 遠.
